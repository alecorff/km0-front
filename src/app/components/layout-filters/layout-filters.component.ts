...
@Component({
  ...
  styleUrl: './layout-filters.component.css'
})
export class LayoutFiltersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const planId = childRoute?.snapshot.paramMap.get('id');
  ...
  applyFilters(): void {
    ...
    console.log("cc");
    this.globalService.setFilteredActivities(this.filteredActivities);
  }
